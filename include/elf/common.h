...
#define NT_RISCV_CSR    0x900		/* RISC-V Control and Status Registers */
					/*   note name must be "LINUX".  */
#define NT_LOONG_CPUCFG 0xa00		/* LoongArch CPU config registers */
					/*   note name must be "LINUX".  */
#define NT_LOONG_CSR    0xa01		/* LoongArch control state registers */
					/*   note name must be "LINUX".  */
#define NT_LOONG_LSX    0xa02		/* LoongArch Loongson SIMD Extension registers */
					/*   note name must be "LINUX".  */
#define NT_LOONG_LASX   0xa03		/* LoongArch Loongson Advanced SIMD Extension registers */
					/*   note name must be "LINUX".  */
#define NT_LOONG_LBT    0xa04		/* LoongArch Loongson Binary Translation registers */
